...
def upgrade() -> None:
    ...
    op.create_table('entries_categories',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    with op.batch_alter_table('entries_categories', schema=None) as batch_op:
        batch_op.create_index('idx_entries_categories_category_id', ['category_id'], unique=False)
        batch_op.create_index('idx_entries_categories_entry_id', ['entry_id'], unique=False)

    op.create_table('entry_scores',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('entry_id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('entry_scores', schema=None) as batch_op:
        batch_op.create_index('idx_entry_scores_entry_id', ['entry_id'], unique=False)
        batch_op.create_index('idx_entry_scores_final_score', ['final_score'], unique=False)
...
def downgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'parent_id', name=op.f('uq_tags_name_parent'))
    )
    with op.batch_alter_table('tags', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('idx_tags_parent_id'), ['parent_id'], unique=False)
        batch_op.create_index(batch_op.f('idx_tags_level'), ['level'], unique=False)
    ...
    with op.batch_alter_table('entries_tags', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('idx_entries_tags_tag_id'), ['tag_id'], unique=False)
        batch_op.create_index(batch_op.f('idx_entries_tags_entry_id'), ['entry_id'], unique=False)
